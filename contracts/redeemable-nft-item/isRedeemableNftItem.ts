...
let NftItemCodeCell = Cell.fromBoc(fs.readFileSync(path.resolve(__dirname, "../build/upgradable-nft-item.cell")))[0]
let NftSingleCodeCell = Cell.fromBoc(fs.readFileSync(path.resolve(__dirname, "../build/upgradable-nft-single.cell")))[0]
